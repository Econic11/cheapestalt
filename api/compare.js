...
<script>
  ...
  function renderComparison(data) {
    ...
    html += '<div class="coll" onclick="tog(this)"><div class="coll-h">Read the full comparison article <span class="coll-ico">&#9662;</span></div><div class="coll-b"><p style="margin-bottom:14px">Get the in-depth analysis of <strong>'+esc(productA.name)+'</strong> vs <strong>'+esc(productB.name)+'</strong>.</p><a href="/products/'+(data.slug||slugA+'-vs-'+slugB)+'" target="_blank" style="display:inline-flex;align-items:center;gap:8px;background:#2563EB;color:#fff;padding:11px 22px;border-radius:8px;font-size:14px;font-weight:700;text-decoration:none">Read full article &#8594;</a></div></div>';
