...
<header style="background:#fff;border-bottom:1.5px solid #E2E8F0;display:grid;grid-template-columns:1fr auto 1fr;align-items:center;padding:0 28px;height:58px;position:sticky;top:0;z-index:200;font-family:Inter,system-ui,sans-serif">
  ...
  <div style="font-size:12px;color:#0F172A;border:1.5px solid #E2E8F0;border-radius:20px;padding:4px 12px;font-weight:500;background:#F8FAFC;justify-self:end;white-space:nowrap">Free · No signup needed</div>
</header>
<style>
...
<footer style="background:#F8FAFC;border-top:1.5px solid #E2E8F0;padding:24px 28px;margin-top:40px;font-family:Inter,system-ui,sans-serif">
  <div style="max-width:760px;margin:0 auto;display:flex;justify-content:space-between;flex-wrap:wrap;gap:12px;font-size:13px;color:#0F172A;align-items:center">
    <span>© 2026 CheapestAlt. All rights reserved.</span>
...
function pageAbout() {
  return {
    ...
    <div class="card"><h3>🤖 AI-powered, not sponsored</h3><p>Our results come from Claude AI analyzing real product data — not paid placements. We never accept money to rank a product higher.</p></div>
    <div class="card"><h3>💰 Genuinely cheaper alternatives</h3><p>We only show alternatives that are meaningfully cheaper. We calculate real savings percentages and explain exactly why each alternative is worth considering.</p></div>
    <div class="card"><h3>⚡ Built for speed</h3><p>Results in seconds. No accounts, no sign-up, no spam. Just search and save.</p></div>
...
function pageContact() {
  return {
    ...
    <h1>Get in touch</h1>
    <p class="lead">We're a small team and we read every message. Expect a reply within 24–48 hours.</p>
    ...
    <div class="card" style="margin-top:16px">
      <h3>🤝 Partnership & affiliate inquiries</h3>
