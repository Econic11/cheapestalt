...
function buildAltHTML(d, product, angle, rawSlug, amzProducts, amazonSection) {
  ...
  return '<!DOCTYPE html><html lang="en"><head>' +
    ...
    '<style>*{box-sizing:border-box;margin:0;padding:0}body{font-family:Inter,sans-serif;background:#fff;color:#0F172A}.hdr{background:#fff;border-bottom:1.5px solid #E2E8F0;padding:0 28px;height:58px;display:flex;align-items:center;justify-content:space-between}.logo{font-size:18px;font-weight:800;text-decoration:none;color:#0F172A}.logo em{color:#2563EB;font-style:normal}.nav a{background:#2563EB;color:#fff;padding:7px 16px;border-radius:8px;font-size:13px;font-weight:600;text-decoration:none;margin-left:6px}.wrap{max-width:860px;margin:0 auto;padding:44px 24px 80px}h1{font-size:28px;font-weight:800;margin-bottom:12px}.lead{font-size:15px;color:#475569;margin-bottom:28px}.disc{background:#F8FAFC;border:1.5px solid #E2E8F0;border-radius:10px;padding:12px 16px;font-size:12px;color:#475569;margin-top:24px}.ftr{background:#F8FAFC;border-top:1.5px solid #E2E8F0;padding:24px 28px;font-size:13px;color:#475569}.ftr-in{max-width:860px;margin:0 auto;display:flex;justify-content:space-between;flex-wrap:wrap;gap:12px;align-items:center}.ftr-in a{color:#0F172A;text-decoration:none;font-weight:500}.ftr-in a:hover{color:#2563EB}@media(max-width:640px){.hdr{flex-direction:column;height:auto;padding:12px 16px;gap:10px;align-items:center;text-align:center}.nav a{font-size:12px;padding:6px 10px;white-space:nowrap}}</style>' +
    '</head><body>' +
    '<header class="hdr"><a href="/" class="logo">Cheapest<em>Alt</em></a><nav class="nav"><a href="/">Find Alternatives</a><a href="https://cheapestalt.com/compare">Compare Products</a></nav><div class="tag">Free &middot; No signup needed</div></header>' +
    '<main class="wrap">' +
    '<h1>' + esc(title) + '</h1>' +
    ...
    '<footer class="ftr"><div class="ftr-in"><span>&copy; 2026 CheapestAlt. All rights reserved.</span><div style="display:flex;gap:16px;flex-wrap:wrap"><a href="/">Home</a><a href="/#about">About</a><a href="/#how-it-works">How it works</a><a href="/#disclosure">Affiliate Disclosure</a><a href="mailto:Support@cheapestalt.com">Contact</a></div></div></footer>' +
    '</body></html>';
}
...
function buildCmpHTML(d, rawSlug, imgA, imgB, amazonSection) {
  ...
  return '<!DOCTYPE html><html lang="en"><head>' +
    ...
    '<meta name="description" content="' + esc(desc) + '"/>' +
    '<link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;600;700;800&display=swap" rel="stylesheet"/>' +
    '<style>*{box-sizing:border-box;margin:0;padding:0}body{font-family:Inter,sans-serif;background:#fff;color:#0F172A}.hdr{background:#fff;border-bottom:1.5px solid #E2E8F0;padding:0 28px;height:58px;display:flex;align-items:center;justify-content:space-between}.logo{font-size:18px;font-weight:800;text-decoration:none;color:#0F172A}.logo em{color:#2563EB;font-style:normal}.nav a{background:#2563EB;color:#fff;padding:7px 16px;border-radius:8px;font-size:13px;font-weight:600;text-decoration:none}.wrap{max-width:860px;margin:0 auto;padding:44px 24px 80px}h1{font-size:26px;font-weight:800;margin-bottom:20px}.ftr{background:#F8FAFC;border-top:1.5px solid #E2E8F0;padding:24px 28px;font-size:13px;color:#475569}.ftr-in{max-width:860px;margin:0 auto;display:flex;justify-content:space-between;flex-wrap:wrap;gap:12px;align-items:center}.ftr-in a{color:#0F172A;text-decoration:none;font-weight:500}.ftr-in a:hover{color:#2563EB}@media(max-width:640px){.hdr{flex-direction:column;height:auto;padding:12px 16px;gap:10px;align-items:center;text-align:center}.nav a{font-size:12px;padding:6px 10px;white-space:nowrap}}</style>' +
    '</head><body>' +
    '<header class="hdr"><a href="/" class="logo">Cheapest<em>Alt</em></a><nav class="nav"><a href="/">Find Alternatives</a><a href="https://cheapestalt.com/compare">Compare Products</a></nav><div class="tag">Free &middot; No signup needed</div></header>' +
    '<main class="wrap">' +
    '<h1>' + esc(title) + '</h1>' +
